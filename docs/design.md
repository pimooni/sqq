...
- Cross-frame cage tracking, persistent cage IDs, lifetime/event/residence statistics, and Track-specific render packages are assigned to SQQ 0.5.1 and are not part of 0.4.1.
