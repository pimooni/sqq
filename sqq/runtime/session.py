"""Lifecycle facade over the shared runtime runner."""
...
from .runner import AnalysisRunner as RuntimeAnalysisRunner
from .contracts import FrameTask, RunPlan, TaskOutcome
from .parallel.events import StageEvent, StageEventKind
from .parallel.executor import TaskHandler
