"""Worker-safe engine dispatch for one already loaded frame."""
...
from ..core.common.selection import select_guests, select_waters
from ..core.sqq_cpp import analyze_frame_cpp
from ..core.sqq_py import analyze_frame as analyze_frame_py
from ..io.input.pairs import read_pair_edges
