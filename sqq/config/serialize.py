...
_INLINE_COMMENTS: dict[tuple[str, ...], str] = {
    ...
    ("component", "auto_classify"): "choices: true, false",
    ("component", "unknown_role"): "choices: water, guest, additive, environment, other",
    ...
    ("ring", "chordless"): "choices: true, false; compatibility mirror of ring.definition",
    ...
    ("cage", "enabled"): "choices: true, false",
    ("cage", "search_mode"): "choices: grow, pair, patch_pair",
    ("cage", "seed_mode"): "choices: ring, patch",
    ("cage", "scientific_validation"): "choices: true, false",
    ("cage", "occupancy_mode"): "choices: polyhedron, center, auto",
    ...
    ("ice", "enabled"): "choices: true, false",
    ("ice", "method"): "choices: chill",
    ("ice", "require_four_coord_neighbor"): "choices: true, false",
    ("output", "type"): "choices: default, all, none, " + ", ".join(OUTPUT_TYPE_ORDER),
    ("output", "cage_isomer_row"): "choices: nonzero, all",
    ("output", "write_empty_file"): "choices: true, false",
