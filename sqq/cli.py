...
Analyze options:
  ...
  -o, --output RESULT_DIR        Output directory, default: result_sqq
      ...
      --n-jobs N                 Parallel workers for independent GRO/XYZ files
...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze_parser.add_argument("--n-jobs", metavar="N", default=None, help="Frame-level worker count for independent GRO/XYZ files; default auto runs serially.")
