...
from ...core.common.selection import select_waters
from ...io.input.gro_grouping import GroGroupingResult, scan_and_group_gro_inputs
from ...io.input.lammps import LAMMPS_TRAJECTORY_SUFFIXES
from ...io.input.trajectory import read_frames, read_gro, trajectory_frame_selection
...
def _build_single_source_plan(
    ...
    return RunPlan(
        ...
        frame_times_ps=(
            selection.selected_times_ps if selection is not None else ()
        ),
    )
