...
def analyze_frame_cpp(
    ...
    *,
    ...
    """Run one normalized frame through the packaged SQQ-CPP extension."""
    ...
    native_options = {
        ...
        "cage_target_types": [],
        "cage_report_types": [],
        "max_states_per_seed": int(cage_config.get("max_states_per_seed", 0)),
        "max_total_states": int(cage_config.get("max_total_states", 0)),
